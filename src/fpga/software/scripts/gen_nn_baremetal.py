...
Usage
-----
    python3 scripts/gen_nn_baremetal.py <compiler_output_dir>  \
        [--ddr-base 0x10000000]                                 \
        [--outdir   src/fpga/software/config]                   \
        [--runner   {run_nn, run_nn_uart, test_gemm}]           \
        [--data-loader {tcl, elf}]

All generated files are written to --outdir (default: config) with fixed names.
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default="config",
        metavar="DIR",
        help="Directory where all generated files are written (default: config). "
