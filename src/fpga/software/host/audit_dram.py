...
from nnbaremetal.checks import (
...
def main() -> int:
    p = argparse.ArgumentParser(
        description="Static DRAM-layout guard for VTA baremetal."
    )
    ...
    p.add_argument(
        "--max-addr",
        default=None,
        help="board DRAM ceiling (hex) to enable the fit check",
    )
    args = p.parse_args()
