...
#
# vta_zcu104.tcl: Tcl script for re-creating project 'vta_zcu104'
#
# Generated by Vivado on Fri Apr 17 11:55:40 CEST 2026
...
set script_file "vta_zcu104.tcl"
...
proc print_help {} {
  ...
  puts "$ip_repo     -tclargs \[--ip_repo <path>\]"
  ...
  puts "\[--ip_repo <name>\] Use specified ip location.\n"
...
if { $::argc > 0 } {
  for {set i 0} {$i < $::argc} {incr i} {
    ...
    switch -regexp -- $option {
      ...
      "--ip_repo" { incr i; set ip_repo [lindex $::argv $i] }
      "--help"         { print_help }
      default {
        if { [regexp {^-} $option] } {
...
set orig_proj_dir "[file normalize "$origin_dir/vta_zcu104"]"
...
\
  ...
  # Create instance: VTADefaultShell_0, and set properties
  set VTADefaultShell_0 [ create_bd_cell -type ip -vlnv onera:user:VTADefaultShell:0.2.0 VTADefaultShell_0 ]
  ...
  connect_bd_intf_net -intf_net VTADefaultShell_0_m_axi_gmem [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins VTADefaultShell_0/m_axi_gmem]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins VTADefaultShell_0/s_axi_control]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs VTADefaultShell_0/s_axi_control/reg0] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces VTADefaultShell_0/m_axi_gmem] [get_bd_addr_segs VTADefaultShell_0/s_axi_control/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces VTADefaultShell_0/m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces VTADefaultShell_0/m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces VTADefaultShell_0/m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.994309",
   "Default View_TopLeft":"10,-35",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 1 -x 330 -y 120 -defaultsOSRD
preplace inst VTADefaultShell_0 -pg 1 -lvl 3 -x 1090 -y 120 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 2 -x 790 -y 110 -defaultsOSRD
preplace inst rst_ps8_0_100M -pg 1 -lvl 1 -x 330 -y 330 -defaultsOSRD
preplace netloc rst_ps8_0_100M_peripheral_aresetn 1 1 2 650 210 950J
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 3 10 10 640 200 940J
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 0 2 30 30 630
preplace netloc VTADefaultShell_0_m_axi_gmem 1 1 3 650 10 NJ 10 1230
preplace netloc axi_smc_M00_AXI 1 2 1 N 100
preplace netloc axi_smc_M01_AXI 1 0 3 20 20 NJ 20 930
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 1 1 N 100
levelinfo -pg 1 -10 330 790 1090 1250
pagesize -pg 1 -db -bbox -sgen -10 0 1250 430
"
}
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu7ev-ffvc1156-2-e -flow {Vivado Synthesis 2025} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu7ev-ffvc1156-2-e -flow {Vivado Implementation 2025} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
