...
insn_buffer.append(VTAMemInsn( # I0: LOAD UOP
    ...
    sram_base=0x0000,
    dram_base=0x00002000, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
...
insn_buffer.append(VTAMemInsn( # I3: LOAD WGT
    ...
    sram_base=0x0000,
    dram_base=0x00000060, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
    # Operation over the data
    y_size=1,
    x_size=10, 
...
insn_buffer.append(VTAMemInsn( # I4: LOAD UOP
    ...
    buffer_id=0, # 0-UOP, 1-WGT, 2-INP, 3-ACC, 4-OUT, 5-ACC8bit
    sram_base=0x0001,
    dram_base=0x00002001, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
    # Operation over the data
    y_size=1,
...
for outer_loop in range(0,5):
    for inner_loop in range(0, 5):
        insn_buffer.append(VTAMemInsn( # I10: STORE
            ...
            dram_base=0x00000700 + inner_loop + 5*outer_loop, # TODO: modify to implement full LeNet-5
            unused=0, # UNUSED
            # Operation over the data
            y_size=1,
            x_size=1, 
