...
insn_buffer.append(VTAMemInsn( # I0: LOAD UOP
    ...
    sram_base=0x0000,
    dram_base=0x00001800, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
...
insn_buffer.append(VTAMemInsn( # I4: LOAD UOP
    ...
    buffer_id=0, # 0-UOP, 1-WGT, 2-INP, 3-ACC, 4-OUT, 5-ACC8bit
    sram_base=0x0001,
    dram_base=0x00001801, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
    # Operation over the data
    y_size=1,
...
insn_buffer.append(VTAMemInsn( # I7: STORE
    ...
    sram_base=0x0000,
    dram_base=0x00000500, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
    # Operation over the data
    y_size=1,
    x_size=6,
