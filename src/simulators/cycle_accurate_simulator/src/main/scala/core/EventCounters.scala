...
/** EventCounters.
  ...
  * hardware is the number of clock cycles taken to achieve certain task. We can
  * count the total number of clock cycles spent in a VTA run by checking launch
  * and finish signals.
  *
