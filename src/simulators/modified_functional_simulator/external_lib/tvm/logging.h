...
/* ADDED SECTION TO MANAGE MULTIPLE LOGGING FILES */
#ifndef DMLC_USE_LOGGING_LIBRARY //ADDED
  #define DMLC_USE_LOGGING_LIBRARY "../../external_lib/tvm/logging.h" // ADDED
#endif // ADDED
/* END OF ADDED SECTION */

#include "../dmlc/common.h" //<dmlc/common.h>
