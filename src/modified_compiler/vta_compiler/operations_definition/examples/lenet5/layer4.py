...
# FILENAME
# --------
file_uop_path = compiler_output_filepath("uop_L4.bin")
file_insn_path = compiler_output_filepath("instructions_L4.bin")
...
insn_buffer.append(VTAMemInsn( # I0: LOAD UOP
    ...
    sram_base=0x0000,
    dram_base=0x00007c00, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
...
insn_buffer.append(VTAMemInsn( # I3: LOAD WGT
    ...
    sram_base=0x0000,
    dram_base=0x00000170, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
    # Operation over the data
    y_size=1,
    x_size=48, 
...
insn_buffer.append(VTAMemInsn( # I4: LOAD UOP
    ...
    buffer_id=0, # 0-UOP, 1-WGT, 2-INP, 3-ACC, 4-OUT, 5-ACC8bit
    sram_base=0x0001,
    dram_base=0x00007c01, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
    # Operation over the data
    y_size=1,
