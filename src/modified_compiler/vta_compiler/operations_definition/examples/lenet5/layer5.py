...
# FILENAME
# --------
file_uop_path = compiler_output_filepath("uop_L5.bin")
file_insn_path = compiler_output_filepath("instructions_L5.bin")
...
insn_buffer.append(VTAMemInsn( # I0: LOAD UOP
    ...
    sram_base=0x0000,
    dram_base=0x00008000, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
...
insn_buffer.append(VTAMemInsn( # I3: LOAD WGT
    ...
    sram_base=0x0000,
    dram_base=0x000001a0, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
    # Operation over the data
    y_size=1,
    x_size=6, 
...
insn_buffer.append(VTAMemInsn( # I4: LOAD UOP
    ...
    buffer_id=0, # 0-UOP, 1-WGT, 2-INP, 3-ACC, 4-OUT, 5-ACC8bit
    sram_base=0x0001,
    dram_base=0x00008001, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
    # Operation over the data
    y_size=1,
    x_size=1, # 1 UOP
...
insn_buffer.append(VTAMemInsn( # I6: STORE
    ...
    sram_base=0x0000,
    dram_base=0x00001b00, # TODO: modify to implement full LeNet-5
    unused=0, # UNUSED
    # Operation over the data
    y_size=1,
    x_size=1,
