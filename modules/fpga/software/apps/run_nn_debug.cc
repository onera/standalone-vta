 ...
 *
 * Like run_nn.cc, DDR is pre-initialized via the XSCT script generated by the
 * baremetal codegen (make gen).  In addition to the static model data
 ...
 * embedded via .incbin; with the SD loader (NN_SD_LOADER) they are read from
 * the FAT32 card into the same DDR addresses by vta::sd_load_files() below.
 *
