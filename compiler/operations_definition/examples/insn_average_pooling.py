...
file_uop_path = os.path.join(output_dir, "uop_average_pooling.bin")
file_insn_path = os.path.join(output_dir, "instructions_average_pooling.bin")
...
insn_buffer.append(VTAMemInsn( # I5: FINISH
