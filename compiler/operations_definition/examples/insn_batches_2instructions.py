...
file_uop_path = os.path.join(output_dir, "uop_batches_2insn.bin")
file_insn_path = os.path.join(output_dir, "instructions_batches_2insn.bin")
...
insn_buffer.append(VTAGemInsn( # I2: GEMM
    opcode=2,  # 2-GEMM
    # DEP FLAG
    pop_prev_dep=0,
    pop_next_dep=0,
