...
file_uop_path = os.path.join(output_dir, "uop_32x32_relu.bin")
file_insn_path = os.path.join(output_dir, "instructions_32x32_relu.bin")
...
insn_buffer.append(VTAMemInsn( # I6: LOAD UOP
    opcode=0, # 0-LOAD, 1-STORE, 3-FINISH
    # DEP FLAG
    pop_prev_dep=0, 
    pop_next_dep=0, 
...
insn_buffer.append(VTAAluInsn( # I7: ALU - MAX IMM 0
    opcode=4, # 4-ALU
    # DEP FLAG
    pop_prev_dep=0,
    pop_next_dep=0,
...
insn_buffer.append(VTAMemInsn( # I8: STORE
...
insn_buffer.append(VTAMemInsn( # I9: NOP-MEMORY-STAGE
    opcode=0, # 0-LOAD, 1-STORE, 3-FINISH
    # DEP FLAG
    pop_prev_dep=0,
    pop_next_dep=0,
...
insn_buffer.append(VTAMemInsn( # I10: NOP-COMPUTE-STAGE
    opcode=0, # 0-LOAD, 1-STORE, 3-FINISH
    # DEP FLAG
    pop_prev_dep=1, # Acknowledge LOAD ready signal
...
insn_buffer.append(VTAMemInsn( # I11: FINISH
