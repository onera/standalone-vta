...
insn_buffer.append(VTAMemInsn( # I3: LOAD WGT
    ...
    sram_base=0x0000,
    dram_base=0x00000080, # Exceed classic range due to numerous input data
    unused=0, # UNUSED
    # Operation over the data
    y_size=1,
    x_size=2, # Load 2 WGT
...
# /!\ NOT the adequate STORE, here all OUT buffer is stored whereas only 192 elements are needed
# => It implies 14 STORE instructions with Y_SIZE = 14, X_SIZE = 1, X_STRIDE = 2
#       and SRAM address starting from 0 and being incremented by 28 between each instruction.
insn_buffer.append(VTAMemInsn( # I10: STORE
    ...
    sram_base=0x0000,
    dram_base=0x00000900, # Exceed classic range due to numerous input data
    unused=0, # UNUSED
    # Operation over the data
    y_size=1,
...
insn_buffer.append(VTAMemInsn( # I11: NOP-MEMORY-STAGE
    opcode=0, # 0-LOAD, 1-STORE, 3-FINISH
    # DEP FLAG
    pop_prev_dep=0,
    pop_next_dep=0,
...
insn_buffer.append(VTAMemInsn( # I12: NOP-COMPUTE-STAGE
    opcode=0, # 0-LOAD, 1-STORE, 3-FINISH
    # DEP FLAG
    pop_prev_dep=1, # Acknowledge LOAD ready signal
...
insn_buffer.append(VTAMemInsn( # I13: FINISH
