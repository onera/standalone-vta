...
file_uop_path = os.path.join(output_dir, "uop_lenet5_conv1.bin")
file_insn_path = os.path.join(output_dir, "instructions_lenet5_conv1.bin")
...
uop_buffer.append(VTAUop( # UOP 3 - ALU
    dst_idx=0, 
    src_idx=0,
    wgt_idx=0
))
...
insn_buffer.append(VTAMemInsn( # I4: LOAD UOP
    ...
    # Operation over the data
    y_size=1,
    x_size=3, # Load 3 UOP (2 GeMM + 1 ALU)
    x_stride=3,
    y_pad_top=0,
    y_pad_bottom=0,
    x_pad_left=0,
