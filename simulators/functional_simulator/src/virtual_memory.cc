...
#include "../include/virtual_memory.h" //"virtual_memory.h"

#include "../external_lib/dmlc/logging.h" //<dmlc/logging.h>
...
/* ADDED FUNCTION */
int CheckTestVMEM(int value){ // ADDED
  printf("CheckTestVMEM() successfully tested! \n\r"); // ADDED
