...
if __name__ == "__main__":
    ...
    parser.add_argument("--expand-bias", action="store_true")
    ...
    result = vta_backend(vta_config_dict, args.onnx, doExpandBiasAtCompilation=args.expand_bias, debug=args.debug)
